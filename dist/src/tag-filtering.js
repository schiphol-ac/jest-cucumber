...
var checkIfScenarioMatchesTagFilter = function (tagFilterExpression, feature, scenario) {
    var featureAndScenarioTags = scenario.tags.map(function (tag) { return tag.toLowerCase(); }).concat(feature.tags.map(function (tag) { return tag.toLowerCase(); }));
...
var setScenarioSkipped = function (parsedFeature, scenario) {
    ...
    return __assign({}, scenario, { skippedViaTagFilter: skippedViaTagFilter });
};
exports.applyTagFilters = function (parsedFeature) {
    ...
    var scenarioOutlines = parsedFeature.scenarioOutlines
        ...
        return __assign({}, setScenarioSkipped(parsedFeature, scenarioOutline), { scenarios: scenarioOutline.scenarios.map(function (scenario) { return setScenarioSkipped(parsedFeature, scenario); }) });
    });
    return __assign({}, parsedFeature, { scenarios: scenarios,
